    ...
    async.doWhilst(function (callback) {
        ...
        for (let found = (cursor.goToRange(blockCheckHeight) === blockCheckHeight); found; found = cursor.goToNextDup()) {
            cursor.getCurrentBinary(function (key, data) {  // jshint ignore:line
                ...
                let blockDiff = blockHeader.difficulty;
                let feesToPay = Math.floor(blockHeader.reward * (global.config.payout.pplnsFee / 100));
//                console.log("FeesToPay: " + feesToPay)
                ...
                let rewardTotal = blockHeader.reward - feesToPay;
//                console.log("BlockReward: " + blockHeader.reward + " rewardTotal: " + rewardTotal)
